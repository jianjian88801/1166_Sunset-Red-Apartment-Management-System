               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="租客姓名" prop="zukeName">
                       <el-input v-model="ruleForm.zukeName"
                                 placeholder="租客姓名" clearable  :readonly="ro.zukeName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="租客手机号" prop="zukePhone">
                       <el-input v-model="ruleForm.zukePhone"
                                 placeholder="租客手机号" clearable  :readonly="ro.zukePhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="租客身份证号" prop="zukeIdNumber">
                       <el-input v-model="ruleForm.zukeIdNumber"
                                 placeholder="租客身份证号" clearable  :readonly="ro.zukeIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="zukeEmail">
                       <el-input v-model="ruleForm.zukeEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.zukeEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="单元号" prop="danyuanTypes">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="使用" prop="shiyongTypes">
                        <el-select v-model="ruleForm.shiyongTypes" placeholder="请选择使用">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zukeIdNumber: [
                              { required: true, message: '租客身份证号不能为空', trigger: 'blur' },
                   ...
                   zukePhoto: [
                              { required: true, message: '租客头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   shiyongTypes: [
                              { required: true, message: '使用不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='zukeName'){
                          this.ruleForm.zukeName = obj[o];
                          this.ro.zukeName = true;
                          continue;
                      }
                      if(o=='zukePhone'){
                          this.ruleForm.zukePhone = obj[o];
                          this.ro.zukePhone = true;
                          continue;
                      }
                      if(o=='zukeIdNumber'){
                          this.ruleForm.zukeIdNumber = obj[o];
                          this.ro.zukeIdNumber = true;
                          continue;
                      }
                      if(o=='zukeEmail'){
                          this.ruleForm.zukeEmail = obj[o];
                          this.ro.zukeEmail = true;
                          continue;
                      }
                      if(o=='zukePhoto'){
                          this.ruleForm.zukePhoto = obj[o];
                          this.ro.zukePhoto = true;
                          continue;
                      }
                      if(o=='sexTypes'){
                      ...
                      if(o=='shiyongTypes'){
                          this.ruleForm.shiyongTypes = obj[o];
                          this.ro.shiyongTypes = true;
                          continue;
                      }
                      if(o=='newMoney'){
