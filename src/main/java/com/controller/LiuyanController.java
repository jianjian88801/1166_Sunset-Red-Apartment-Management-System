    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(liuyan !=null){
            ...
            BeanUtils.copyProperties( liuyan , view );//把实体数据重构到view中
                ...
                //级联表
                ZukeEntity zuke = zukeService.selectById(liuyan.getZukeId());
                if(zuke != null){
    ...
    */
    ...
    public R save(@RequestBody LiuyanEntity liuyan, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            liuyan.setZukeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<LiuyanEntity> queryWrapper = new EntityWrapper<LiuyanEntity>()
            .eq("zuke_id", liuyan.getZukeId())
...
//                            liuyanEntity.setZukeId(Integer.valueOf(data.get(0)));   //租客 要改的
