    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(xingcheng !=null){
            ...
            BeanUtils.copyProperties( xingcheng , view );//把实体数据重构到view中
                ...
                //级联表
                ZukeEntity zuke = zukeService.selectById(xingcheng.getZukeId());
                if(zuke != null){
    ...
    */
    ...
    public R save(@RequestBody XingchengEntity xingcheng, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            xingcheng.setZukeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<XingchengEntity> queryWrapper = new EntityWrapper<XingchengEntity>()
            .eq("zuke_id", xingcheng.getZukeId())
            .eq("gonggao_name", xingcheng.getGonggaoName())
            ;

        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        XingchengEntity xingchengEntity = xingchengService.selectOne(queryWrapper);
        if(xingchengEntity==null){
...
//            xingcheng.setZukeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        XingchengEntity xingchengEntity = xingchengService.selectOne(queryWrapper);
        if("".equals(xingcheng.getXingchengPhoto()) || "null".equals(xingcheng.getXingchengPhoto())){
                xingcheng.setXingchengPhoto(null);
        }
        if(xingchengEntity==null){
            //  String role = String.valueOf(request.getSession().getAttribute("role"));
            //  if("".equals(role)){
...
//                            xingchengEntity.setZukeId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            xingchengEntity.setXingchengPhoto("");//照片
//                            xingchengEntity.setGonggaoName(data.get(0));                    //行程轨迹 要改的
...
//                            xingchengEntity.setCreateTime(date);//时间
    ...
    */
    @RequestMapping("/add")
    public R add(@RequestBody XingchengEntity xingcheng, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,xingcheng:{}",this.getClass().getName(),xingcheng.toString());
        Wrapper<XingchengEntity> queryWrapper = new EntityWrapper<XingchengEntity>()
            .eq("zuke_id", xingcheng.getZukeId())
            .eq("gonggao_name", xingcheng.getGonggaoName())
            ;
